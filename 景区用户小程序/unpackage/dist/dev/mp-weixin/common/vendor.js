...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"景区管理","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*****************************************************************!*\
  !*** C:/Users/18111/Desktop/北斗/pc_express/青年帮新闻_课堂版/pages.json ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 30 */
/*!***********************************************************************!*\
  !*** C:/Users/18111/Desktop/北斗/pc_express/青年帮新闻_课堂版/utils/request.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function request() {
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      method: method,
      data: data,
      header: _objectSpread(_objectSpread({}, token ? {
...
/* 34 */
/*!************************************************************************!*\
  !*** C:/Users/18111/Desktop/北斗/pc_express/青年帮新闻_课堂版/utils/location.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.startLocationReport = startLocationReport;
exports.stopLocationReport = stopLocationReport;
...
var INTERVAL = 60 * 1000; // 每分钟一次
var timer = null;

// 上报一次当前坐标
function reportOnce() {
  if (!(0, _request.getToken)()) return; // 未登录不上报
  uni.getLocation({
    type: 'gcj02',
    // 与国内地图（高德/腾讯）一致
    success: function success(res) {
      (0, _request.request)({
        ...
        return console.error('坐标上报失败', e);
      });
    },
    fail: function fail(e) {
      return console.error('获取定位失败', e);
    }
  });
}
...
/* 60 */
/*!********************************************************************!*\
  !*** C:/Users/18111/Desktop/北斗/pc_express/青年帮新闻_课堂版/utils/tool.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
